 ...
 * 
 * changelog:
 * beta2 - Shoots a flower instead (under development) 2025-2026
...
//TODO fix bug with upside down images
function Person(angle, numberInRow, fromWhere) {
  ...
  else if(fromWhere == "right") {//TODO fix bug with upside down images
    //TODO fix bug with upside down images
  	this.top = 40;
...
function addNewPerson() {
	...
	if(rand == 1) {
		var person = new Person(0, peopleAdded, "right");
